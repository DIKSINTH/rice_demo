...
const Rice3 = () => {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <div className="min-h-screen flex flex-col md:flex-row items-center justify-between px-6 md:px-12 lg:px-20 py-12 gap-10 bg-[#5A0B0B]">
        {/* Left Section */}
        <div className="md:w-1/2 space-y-6 text-center md:text-left">
          ...
          {/* Paragraphs grouped */}
          <div className="space-y-4 text-sm hidden sm:text-base hidden md:text-lg leading-relaxed text-gray-200">
            <p>
