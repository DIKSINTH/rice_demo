...
const Home = () => {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <div className="min-h-screen flex flex-col items-center justify-center px-6 md:px-12 lg:px-20 py-12 bg-[#5A0B0B] gap-8 text-center">
        {/* Heading */}
        ...
        {/* Paragraphs */}
        <div className="space-y-4 text-sm sm:text-base md:text-lg leading-relaxed text-gray-200 max-w-2xl">
          <p>
