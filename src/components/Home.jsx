  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col md:flex-row items-center justify-between px-6 md:px-12 lg:px-20 py-12 bg-[#5A0B0B] gap-10">
        {/* Left side content wrapper (Heading + Buttons + Paragraphs) */}
        <div className="flex flex-col items-center md:items-start text-center md:text-left md:w-1/2 space-y-6 order-1 md:order-1">
          {/* Heading */}
        ...
        <div className="md:w-1/2 flex items-center justify-center order-2 md:order-2">
